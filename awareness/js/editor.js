...
App.Editor = (function () {
  ...
  /* ────────────────────────────────────────────────────────
     ...
     ──────────────────────────────────────────────────────── */
  const ELEMS = [
    { icon: 'H',  label: 'Heading',    html: `<div style="font-family:Arial,Helvetica,sans-serif;font-size:1.4rem;color:#0A0A0A;font-weight:700;line-height:1.2;padding:.3rem 0 .5rem">New Heading</div>` },
