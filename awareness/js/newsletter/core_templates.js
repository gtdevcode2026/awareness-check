...
${redFlagsRowsHtml}
  ...
  function buildGenSocialEngineering(c, arts, wo, lk, poster, qr, illus) {
    ...
    let HTML = `${nlOuterOpen()}<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" bgcolor="#FFFFFF" style="background:#FFFFFF;">`
      ...
      + `<tr><td style="padding:28px 34px 18px;background:#FFFFFF;"><table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">`
  ...
  function buildCyberGazette(c, arts, wo, lk, poster, qr, illus) {
    ...
    const leadStory = `${tbl()}${tbc(
      `<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>`
      + `<td width="232" valign="middle" align="center" style="padding-right:22px;text-align:center;">${imgSlot(lead, 'width="232" height="180" style="display:block;width:100%;max-width:232px;height:180px;object-fit:cover;margin:0 auto;border:1px solid #0A0A0A;"', GAZETTE_LEAD_IMAGE)}</td>`
