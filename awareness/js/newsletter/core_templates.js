...
${redFlagsRowsHtml}
  ...
  function buildMfaExtraStep(c, arts, wo, lk, poster, qr, illus) {
    ...
    const intruder =
      ...
      + `</td></tr></table>`;
    const crackedChip =
      `<table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center"><tr><td bgcolor="#0A0A0A" style="background-color:#0A0A0A;border:1px solid #C09010;border-radius:8px;padding:9px 16px;font-family:Arial,Helvetica,sans-serif;font-weight:700;font-size:16px;letter-spacing:2px;color:#D4A420;">!(#:@*!$%#</td></tr></table>`;
    const threatRow =
    ...
    const fieldRow = (label, value, hot) =>
      `<tr><td style="padding:9px 20px 0;">`
        ...
        + `<table width="100%" role="presentation" border="0" cellpadding="0" cellspacing="0"><tr>`
          + `<td bgcolor="${hot ? '#FFF6DD' : '#F4F4F4'}" style="background-color:${hot ? '#FFF6DD' : '#F4F4F4'};border:1px solid ${hot ? '#D4A420' : '#E2E2E2'};border-radius:7px;padding:10px 12px;font-family:Arial,Helvetica,sans-serif;font-weight:700;font-size:14px;color:#0A0A0A;letter-spacing:${hot ? '2px' : '0'};">${value}</td>`
        + `</tr></table>`
      + `</td></tr>`;
    const loginCard =
    ...
    const phoneCard =
      ...
      + `<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" bgcolor="#0A0A0A" style="background:#0A0A0A;border:1px solid #C09010;border-radius:18px;">`
        ...
        + `<tr><td align="center" style="padding:12px 18px 2px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center"><tr><td bgcolor="#161616" style="background-color:#161616;border:1px solid #C09010;border-radius:8px;padding:10px 18px;font-family:Arial,Helvetica,sans-serif;font-weight:800;font-size:20px;letter-spacing:4px;color:#D4A420;">${CODE}</td></tr></table></td></tr>`
